    ...
    <div className="min-h-screen bg-app-900">
      ...
      <section id="evidence" className="border-b border-line bg-app-880">
        <div className="mx-auto max-w-[1240px] px-5 py-16">
          ...
          <div className="mt-9 grid grid-cols-1 gap-6 lg:grid-cols-12">
            <div className="lg:col-span-5">
              <div className="overflow-hidden rounded-[6px] border border-line bg-app-850">
                <PanelHeader
                  ...
                  subtitle="Sample · ranked by severity · evidence attached"
            ...
            <div className="lg:col-span-7">
              <p className="mb-2 font-mono text-[8.5px] uppercase tracking-[0.13em] text-faint">
                Sample capture
              </p>
        ...
        <div className="mx-auto max-w-[1240px] px-5 py-16">
          ...
          <div className="mt-6 grid grid-cols-1 gap-px overflow-hidden rounded-[6px] border border-line bg-line md:grid-cols-3">
            {[
              ...
              ["Rate & budget limits", "Request-per-minute limits and scopes cap every run, protecting the target from load."],
            ].map(([title, body]) => (
          ...
          <div className="mt-9 grid grid-cols-1 gap-6 lg:grid-cols-12">
            <div className="lg:col-span-7">
              <div className="overflow-hidden rounded-[6px] border border-line bg-app-850">
                <div className="flex items-center gap-3 border-b border-line px-4 py-2.5">
                  ...
                  <span className="ml-auto font-mono text-[8px] text-faint">sample layout</span>
                </div>
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 border-t border-line pt-4">
                    ...
                    <p className="mt-2 text-[10px] leading-[1.9] text-muted">
                      Sample layout: every recorded finding passed deterministic verification
                      and ships with captured evidence — request and response pairs, DOM state,
                      and console output.
                    </p>
                  </div>
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 border-t border-line px-4 py-2 font-mono text-[7.5px] text-faint">
                  <span>generated by Sentinel · sample layout</span>
                  <span className="ml-auto">HTML · JSON · Markdown · CSV</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="space-y-px overflow-hidden rounded-[6px] border border-line bg-line">
                {[
                  ["JSON", "Machine-readable output for pipelines and ticketing automation.", "per-run download"],
                  ["Markdown", "Structured text for repositories, pull requests, and engineering documentation.", "per-run download"],
                  ["HTML + CSV", "Formatted human-readable report plus tabular findings for triage.", "per-run download"],
              ...
              <div className="mt-4 rounded-[6px] border border-line bg-app-850 p-5">
                <div className="text-[8px] font-semibold uppercase tracking-[0.13em] text-faint">
                  Baseline tracking in every run
                </div>
                <p className="mt-2 text-[9.5px] leading-[1.85] text-muted">
                  Each run is compared against the previous sealed report — new, fixed and
                  unchanged findings — so regressions fail the pipeline before they ship.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="architecture" className="border-b border-line">
        <div className="mx-auto max-w-[1240px] px-5 py-16">
          ...
          <div className="mt-9 overflow-hidden rounded-[6px] border border-line">
            <div className="grid grid-cols-1 gap-px bg-line lg:grid-cols-5">
              {[
                ...
                [<Database key="4" size={14} />, "Evidence store", "Screenshots, DOM snapshots, request/response pairs and console output attached to every finding."],
                [<FileText key="5" size={14} />, "Reporting layer", "Severity ranking with export to JSON, Markdown, HTML and CSV."],
              ].map(([icon, title, body]) => (
                <div key={title as string} className="bg-app-880 p-5">
          ...
          <div className="mt-6 grid grid-cols-1 gap-px overflow-hidden rounded-[6px] border border-line bg-line md:grid-cols-3">
            {[
              ["Deployment", "Runs as a hosted dashboard or locally from your own machine, against targets you own or may test."],
              ["Exports", "Every run seals Markdown, JSON, HTML and CSV artifacts plus a TestIO bundle, downloadable per run."],
              ["Responsible use", "Per-run authorization declarations stamped onto reports, invite-only signup, and a published abuse contact."],
            ].map(([title, body]) => (
              <div key={title} className="bg-app-880 p-5">
                <h3 className="text-[10px] font-semibold uppercase tracking-[0.11em] text-ink-soft">
                  {title}
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[11.5px] font-semibold text-ink">Sentinel</span>
              </div>
